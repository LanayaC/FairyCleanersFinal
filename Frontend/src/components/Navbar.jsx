...
function Navbar() {
    ...
    const navItems = (
        <>
            ...
            <li>
                <a href="/community-and-feedback">Community and Feedback</a>
            </li>
        </>
    );
    ...
    return (
        <>
            <div
                className={`dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${
                    sticky ? "sticky-navbar shadow-lg bg-base-200 dark:bg-slate-500 dark:text-white duration-300 transition-all ease-in-out" : ""
                }`}
            >
                <div className="max-w-screen-2xl container mx-auto md:px-20 px-4">
                    <div className="navbar">
                        <div className="navbar-start">
                            ...
                            <a className="text-3xl font-extrabold cursor-pointer text-gradient2 text-center">
                                Fairy Cleaners
                            </a>
                        </div>
                        ...
                        <div className="navbar-end space-x-3">
                            ...
                            <div>
                                <a className="bg-indigo-200 text-white p-2 rounded-md hover:bg-pink-400 cursor-pointer dark:bg-slate-700 dark:hover:bg-pink-400 duration-500"
